    ...
    <div className="w-full min-w-160 bg-white rounded-lg p-6 flex flex-col">
      ...
      <div>
        ...
        <textarea
          ...
          rows={8}
        />
        <p className={`text-red-500 text-sm mt-1 ${errors.description ? "visible" : "invisible"}`}>
          {errors.description}!
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded px-3 py-2"
        />
        <p className={`text-red-500 text-sm mt-1 ${errors.price ? "visible" : "invisible"}`}>
          {errors.price}!
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded px-3 py-2"
        />
        <p className={`text-red-500 text-sm mt-1 ${errors.quantity ? "visible" : "invisible"}`}>
          {errors.quantity}!
        </p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded px-3 py-2"
        />
        <p className={`text-red-500 text-sm mt-1 ${errors.low_stock_threshold ? "visible" : "invisible"}`}>
