...
SECRET_KEY = os.environ.get("DJANGO_SECRET", '#=#zbn!)fwrl=c9c(403ja=p&*6funs*-ft+++&v0$c-u4*+79')
...
CSRF_TRUSTED_ORIGINS = [host for host in os.environ.get("DJANGO_BASE_URL", "http://localhost:8000").split(",")]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get("DJANGO_DB_NAME", "integrage"),
