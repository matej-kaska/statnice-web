    ...
    <div className="min-h-screen flex items-center justify-center bg-second/10">
      ...
      >
        ...
        <div className="mb-1">
          <label
            htmlFor="first_name"
            className="block mb-1 text-main"
          >
            First Name
          </label>
          <input
          ...
          />
          <p className={`mt-1 text-sm text-red-500 ${errors.first_name ? "visible" : "invisible"}`}>
            {errors.first_name}!
          </p>
        </div>
        <div className="mb-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded"
          />
          <p className={`mt-1 text-sm text-red-500 ${errors.last_name ? "visible" : "invisible"}`}>
            {errors.last_name}!
          </p>
        </div>
        <div className="mb-1">
        ...
        <div className="mb-1">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded"
          />
          <p className={`mt-1 text-sm text-red-500 ${errors.confirm_password ? "visible" : "invisible"}`}>
