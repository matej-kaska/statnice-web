...
const Snackbar = ({ message, type, fade, closeSnackbar }: SnackbarProps) => {
  const wrapperClasses = [
    "fixed top-4 left-1/2 z-150 transform -translate-x-1/2",
  ...
  const containerClasses = [
    "inline-flex items-center px-4 py-2 rounded-md shadow-md border-t-4",
    type === "success"
  ...
  return (
    ...
    >
      <div className={containerClasses}>
        ...
        <p className="select-none font-semibold text-base text-black">
          {message}
        </p>
      </div>
    </div>
